...
public class BoardController {
   ...
   public ModelAndView view(BoardVo bVo, BoardPageVo pVo) {
      ModelAndView mv = new ModelAndView();
      //조회수 증가
   ...
   public ModelAndView delete(BoardVo bVo, BoardPageVo pVo) {
      String msg = "";
      ModelAndView mv = new ModelAndView();
   ...
   public ModelAndView insert(BoardPageVo pVo) {
      ModelAndView mv = new ModelAndView();
      mv.addObject("pVo", pVo);
   ...
   public ModelAndView update(BoardPageVo pVo) {
      ModelAndView mv = new ModelAndView();
   ...
   public ModelAndView repl(BoardPageVo pVo, BoardVo bVo) {
      ModelAndView mv = new ModelAndView();
      mv.addObject("pVo", pVo);
      mv.addObject("bVo", bVo);
